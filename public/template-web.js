			...
			var r = n(17),
				...
				a = function c(e) {
					...
					'string' != typeof e ? (t = e) : (t.source = e),
						(t = o.$extend(t)),
						(e = t.source),
						t.debug && ((t.cache = !1), (t.bail = !1), (t.minimize = !1), (t.compileDebug = !0)),
			...
			var r = {
					...
					switch (('#' === t && h('#value', '@value'), f)) {
						...
						case 'each':
							(p = r._split(a)),
								p.shift(),
								'as' === p[1] &&
									(h('each object as value index', 'each object value index'), p.splice(1, 1));
							var d = p[0] || '$data',
								v = p[1] || '$value',
								g = p[2] || '$index';
				...
				_split: function(e) {
					for (var t = 0, n = e.shift(), r = [[n]]; t < e.length; ) {
						...
						'whitespace' !== i &&
							'comment' !== i &&
							(('punctuator' === n.type && ']' !== n.value) || 'punctuator' === i
								? r[r.length - 1].push(o)
								: r.push([o]),
							(n = o)),
							t++;
								...
								e.compileDebug
									? (r.push('try{'),
									  n.forEach(function(e) {
											e.tplToken.type === i.TYPE_EXPRESSION &&
												r.push(h + '=[' + [e.tplToken.line, e.tplToken.start].join(',') + ']'),
			...
			var s = (function(e) {
				function t(n) {
					...
					var i = o(this, e.call(this, n)),
						s = n.message;
					return (
						t.debugTypes[n.name] && (n.source && (s = t.debug(n)), (i.path = n.path)),
		...
		function(e, t, n) {
			...
			(function(t) {
				...
				var r = n(0),
					...
					u = function(e, t) {
						if (Array.isArray(e)) for (var n = 0, r = e.length; n < r; n++) t(e[n], n, e);
						...
						for (
							...
							if ('string' === r[s].type) {
								for (
									...
									if ('string' === d)
										v && 'string' === v.type ? ((v.value += h), (v.end += h.length)) : l.push(b);
									else {
